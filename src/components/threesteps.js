...
const ThreeSteps = React.forwardRef((props, ref) => {
    return (
        <div className="p-4" ref={ref}>
            <h2 className="text-gray-800 font-normal text-center">Getting Started</h2>
            <div className="flex flex-col lg:flex-row justify-center text-center">

                <div id="stepCard1" className="stepCards flex flex-col items-center m-2 lg:w-1/3 p-4 rounded shadow-2xl bg-white border-gray-800 border-t-8">
                    <p className="rounded-full h-10 w-10 flex items-center justify-center border border-gray-800">1</p>
                ...
                <div id="stepCard2" className="stepCards flex flex-col items-center m-2 lg:w-1/3 p-4 rounded shadow-2xl bg-white border-gray-800 border-t-8">
                    <p className="rounded-full h-10 w-10 flex items-center justify-center border border-gray-800">2</p>
                    <h3 className="uppercase">{threeStepCardText.step2.header}</h3>
                    <p>{threeStepCardText.step2.text}</p>
                </div>
                {/* ^^^ Update this section as needed ^^^ */}

                <div id="stepCard3" className="stepCards flex flex-col items-center m-2 lg:w-1/3 p-4 rounded shadow-2xl bg-white border-gray-800 border-t-8">
                    <p className="rounded-full h-10 w-10 flex items-center justify-center border border-gray-800">3</p>
