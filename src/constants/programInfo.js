...
export const leadContent = {
    ...
    paragraph: `${schoolName} designs its programs to provide students with a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "Choose between the Full Stack JavaScript, User Experience Design Full-Time, and User Experience Design Part-Time programs."
    },
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $14,900 for tuition & $10,000 for cost of living for the Full Stack JavaScript & User Experience Design Full-Time programs or up to $5,400 for tuition for the UX Part-Time program."
